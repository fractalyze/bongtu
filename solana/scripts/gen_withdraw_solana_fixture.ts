...
//
// OPEN-3 truncate-253 (see solana/program/src/recipient_binding.rs): the
...
//   node_modules/.bin/tsx solana/scripts/gen_withdraw_solana_fixture.ts
//
...
//        contracts/test/fixtures/consumer_realproofs.json (the EVM twin, for belts)
// Writes contracts/test/fixtures/consumer_realproofs_solana.json
...
const FIXDIR = join(REPO, "contracts", "test", "fixtures");
...
async function main(): Promise<void> {
  ...
  const out = {
    comment:
      "GENERATED by solana/scripts/gen_withdraw_solana_fixture.ts — the ONE re-proven " +
