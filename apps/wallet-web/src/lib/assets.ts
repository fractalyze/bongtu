...
// Cache Storage prefetch (@bongtu/ui/assets, issue #46) to the consumer wallet's
// circuit family (depositPriv/transferPriv/transfer10x2Priv/withdrawPriv) and its
// pinned CIRCUITS_VERSION. Flow logic, eviction rules and the injectable browser
// surface live in the shared module; this file only supplies the config and keeps
// the app's import surface.
