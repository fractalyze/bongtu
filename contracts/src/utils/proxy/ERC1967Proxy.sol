...
///      calls are delegated to an implementation address that can be changed.
///      This address is stored in storage in the location specified by
///      https://eips.ethereum.org/EIPS/eip-1967[ERC-1967], so that it doesn't
...
contract ERC1967Proxy is Proxy {
    ...
    /// `implementation`. This will typically be an encoded function call, and
    /// allows initializing the storage of the proxy like a Solidity constructor.
    ///
    /// Requirements:
    ///
    ...
    /// shown below (specified by ERC-1967) using the
