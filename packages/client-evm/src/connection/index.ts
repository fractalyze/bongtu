...
// How a browser REACHES a wallet (wagmi, EIP-6963, WalletConnect) is the ui layer's
// business: packages/ui/src/wagmi.ts turns whatever wagmi connected into
...
// transports in apps/treasury-web/test/connection.test.ts — that file also gates
...
// (@bongtu/client-evm/connection); the implementation lives in the sibling parts.
export * from "./edge.js";
