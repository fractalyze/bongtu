...
# broadcast.
#
#   cd bongtu && bash deploy/gates/test_upgrade_ladder_v5.sh   # exits 0 iff all pass
#
...
step "UpgradePq (V2)"         upgrades/UpgradePq.s.sol:UpgradePq
step "UpgradeSelfSend (V3)"   upgrades/UpgradeSelfSend.s.sol:UpgradeSelfSend
step "UpgradeTransfer10 (V4)" upgrades/UpgradeTransfer10.s.sol:UpgradeTransfer10
step "UpgradeTransfer10x2 (V5)" upgrades/UpgradeTransfer10x2.s.sol:UpgradeTransfer10x2
...
NEG_LOG="$(mktemp)"
if ( cd contracts && "$FORGE" script ../deploy/forge/upgrades/UpgradeTransfer10x2.s.sol:UpgradeTransfer10x2 \
