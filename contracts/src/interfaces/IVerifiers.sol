...
// (deposit 19, withdraw 26, disburse 11, transfer 37, transfer10 141 — derived
// from the committed out/<name>.public.json + .sym), so each verifier has its own
// typed arity and a nPublic-changing circuit edit is BREAKING (SPEC §5.3).
