...
//         contracts/test/fixtures/consumer_realproofs.json (committed EVM
//         realproof fixtures: depositPriv, transferPriv, transfer10x2Priv),
//         contracts/test/fixtures/consumer_realproofs_solana.json (the ONE
//         re-proven withdrawPriv fixture, Solana-bound recipient — SOLR §5.2)
// Writes  solana/conformance/poseidon_vectors.json   (gate 1 vectors)
//         solana/conformance/<op>_fixture.json x4    (gates 2/3/5 harness input)
//         solana/program/src/generated/zeros.rs      (IMT empty-subtree constants)
//
...
const FIXTURE = join(REPO, "contracts", "test", "fixtures", "consumer_realproofs.json");
...
function poseidonVectors(): object {
  ...
  return {
    comment:
      "GENERATED by solana/scripts/gen_vectors.ts from packages/core (poseidon-lite). " +
...
function zerosRs(zeros: bigint[]): string {
  const rows = zeros
    ...
    .join("\n");
  return `// GENERATED by solana/scripts/gen_vectors.ts from packages/core ImtTree
// — DO NOT EDIT. zeros[k] = value of an all-empty subtree of height k:
// zeros[0] = 0, zeros[k] = Poseidon2(zeros[k-1], zeros[k-1]). Big-endian.
// Regenerate: node_modules/.bin/tsx solana/scripts/gen_vectors.ts
...
function transferFixture(fx: EvmFixture): object {
  ...
  return {
    comment:
      "GENERATED by solana/scripts/gen_vectors.ts from the committed EVM transferPriv " +
      "realproof fixture (contracts/test/fixtures/consumer_realproofs.json) + the " +
...
function depositFixture(fx: EvmFixture): object {
  ...
  return {
    comment:
      "GENERATED by solana/scripts/gen_vectors.ts from the committed EVM depositPriv " +
...
function transfer10x2Fixture(fx: EvmFixture): object {
  ...
  return {
    comment:
      "GENERATED by solana/scripts/gen_vectors.ts from the committed EVM transfer10x2Priv " +
      "realproof fixture + the packages/core ImtTree oracle. Mollusk gates 2/5 input.",
    proof: proofHex(fx),
    publicsCarried: carried,
    publicsFull: fx.pub,
...
function withdrawFixture(
  ...
  return {
    comment:
      "GENERATED by solana/scripts/gen_vectors.ts from the re-proven Solana-recipient " +
      "withdrawPriv fixture (contracts/test/fixtures/consumer_realproofs_solana.json) + " +
