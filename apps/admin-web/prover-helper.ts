...
//
// Run (from apps/admin-web, on the GPU box):
//   PORT=8700 node --import tsx prover-helper.ts
// The GPU env is the same CLAUDE.md GPU contract: CUDA_VISIBLE_DEVICES=0,
// BONGTU_NODE_MODULES set, the 1.24GB artifacts/circuit.zkey present. Cold zkey
// compile is ~2min; warm ~0.5s.

import { createServer } from "node:http";
import { prove } from "@bongtu/prover-cli/prove";
import type { ProvingRequest } from "@bongtu/prover-cli/types";
