...
import { assertDistinctOwnerPubkeys } from "../../sdk/src/note.js";
import type { PointInput } from "../../sdk/src/babyjub.js";
import type { Backend, Calldata, Circuit, ProvingRequest } from "./types.js";

const require = createRequire(import.meta.url);
const HERE = dirname(fileURLToPath(import.meta.url));
const ROOT = join(HERE, "..", ".."); // repo root (prover-cli/src -> repo)
