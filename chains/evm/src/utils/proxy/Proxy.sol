...
// Vendored verbatim from OpenZeppelin Contracts v5.0 (proxy/Proxy.sol).
pragma solidity ^0.8.20;

/// @dev This abstract contract provides a fallback function that delegates all
///      calls to another contract using the EVM instruction `delegatecall`. We
...
abstract contract Proxy {
    ...
    /// @dev This is a virtual function that should be overridden so it returns
    ///      the address to which the fallback function and {_fallback} should
    ///      delegate.
