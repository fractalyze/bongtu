...
//
// This is the CONSUMER wallet (issue #13), and two treasury-web knobs are ABSENT
...
// Structured exactly like treasury-web's CIRCUITS_VERSION: first 8 of sha256 over the
