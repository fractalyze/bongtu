...
1.24GB zkey / no rabbitsnark GPU in the loop** (those are M1). Ref: [spec.md](spec.md) §4, §5, §10b.
...
Toolchain + exact commands: [toolchain.md](toolchain.md). Product decisions: [spec.md](spec.md). Not git-tracked: zkey/wtns/r1cs.
