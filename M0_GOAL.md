...
1.24GB zkey / no rabbitsnark GPU in the loop** (those are M1). Ref: SPEC.md §4, §5, §10b.
...
Toolchain + exact commands: `TOOLCHAIN.md`. Product decisions: `SPEC.md`. Not git-tracked: zkey/wtns/r1cs.
