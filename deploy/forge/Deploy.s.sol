...
/// field list and the merge-write live in `deploy/forge/AddressBook.sol`, shared with
...
contract Deploy is Script {
    ...
    /// The deployed record is an `AddressRecord` (deploy/forge/AddressBook.sol) — the
