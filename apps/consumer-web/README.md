...
[`docs/wallet.md`](../../docs/wallet.md#the-consumer-wallet-appsconsumer-web); the
...
`vercel.json` rewrite was copied from wallet-web and still points at the
...
different byte family than wallet-web's, alongside a per-asset byte table (the download
